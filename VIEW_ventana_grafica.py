...
def abrir_ventana(entrada1):
    ...
    # Insertar multiplicaciones en la expresión
    expresion = v_grafica_funcionamiento.insertar_multiplicacion(expresion)

    # Obtener el rango de los ejes del usuario
    ...
    # Ajustar el rango de los ejes y añadir líneas verticales
    ax.set_ylim(-5, 5)  # Ajustar el rango de y
    ax.axhline(0, color='blue', linestyle='--')  # Línea horizontal en y=0
    ax.axvline(0, color='blue', linestyle='--')  # Línea vertical en x=0
    ...
    # Preguntar al usuario si desea mostrar la gráfica en 3D
